...
@section('title', 'Lista de productos de compra')
...
@section('content')
    <div class="box box-success">
        ...
        <div class="box-header">
            <a onclick="addForm()" class="btn btn-success"><i class="fa fa-plus"></i> Agregar nueva compra</a>
            <a href="{{ route('exportPDF.productMasukAll') }}" class="btn btn-danger"><i class="fa fa-file-pdf-o"></i> Exportar
                PDF</a>
            <a href="{{ route('exportExcel.productMasukAll') }}" class="btn btn-primary"><i class="fa fa-file-excel-o"></i>
                Exportar Excel</a>
        </div>
        ...
        <!-- /.box-header -->
        <div class="box-body">
            <table id="products-in-table" class="dt-container dt-empty-footer">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Producto</th>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        function editForm(id) {
            ...
            $('#modal-form form')[0].reset();
            $.ajax({
                url: "{{ url('admin/productsIn') }}" + '/' + id + "/edit",
                type: "GET",
                dataType: "JSON",
        ...
        $(function() {
            $('#modal-form form').validator().on('submit', function(e) {
                if (!e.isDefaultPrevented()) {
                    var id = $('#id').val();
                    if (save_method == 'add') url = "{{ url('admin/productsIn') }}";
                    else url = "{{ url('admin/productsIn') . '/' }}" + id;
