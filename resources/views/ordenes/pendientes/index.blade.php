            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="d-flex justify-content-end">
                        <a data-toggle="modal" data-target="#createOrderModal" class="btn btn-primary btn-sm mb-2"
    ...
    <script>
        $(document).ready(function() {
            $('#ordenes-table').DataTable({
                ...
                responsive: true,
                columnDefs: [{
                    targets: [10], // La columna de "Observaciones"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#delete-btn').click(function() {
                ...
                if (ordenCodigo) {
                    $.ajax({
                        url:"{{ route('ordenes.update', '') }}/" + ordenCodigo, // Asegúrate de ajustar esta URL según tu enrutamiento
                        type: 'DELETE',
                        data: {
