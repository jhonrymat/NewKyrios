...
<body>
    <div class="content">
        ...
        <table class="notas">
            <tr>
                <td align="center"><b>Informe Técnico</b></td>
            </tr>
            <tr>
                <td valign="top">{{ $orden->notatecnico }}</td>
            </tr>
        </table>

        <table class="otra">
            <tr>
                <td colspan="2"><b>Fecha de Entrega: </b>
                    <font color="#0C36A4">{{ $orden->fechafin }}</font>
                </td>
                <td colspan="2"><b>Valor: </b>
                    <font color="#0C36A4">$ {{ $orden->valor }}</font>
                </td>
            </tr>
        </table>
        ...
        <table class="otra" style="width: 100%; table-layout: fixed;">
            <tr>
                <td colspan="2" style="width: 50%; padding: 10px; text-align: center; vertical-align: top;">
                    ...
                    @else
                        <div style="display: block; margin: 0 auto;width:150px; height:50px ;"></div>
                    @endif
                    <div style="text-align: center;">
